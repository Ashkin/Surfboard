...
const { saveStripeToken } = order


//TODO: Move this into a Stripe component.
...
class Billing extends Component {
    ...
    render() {
        ...
        return (
            <section className={classBuilder("billing", this.props.className)}>
...
export default reduxForm({
    ...
    connect(mapStateToProps,{ saveStripeToken })(Billing)
)
